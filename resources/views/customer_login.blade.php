...
<body>
    ...
    <div class="container shadow p-3 mb-5 bg-body rounded mt-3" style=" width: 33pc;">
        <div class="text-center">
            ...
            <h1 style="font-family: auto;">Customer Login</h1>
        </div>
        ...
        <div class="text-center mt-3">
            <a href="{{ route('forget_password') }}" class="text-decoration-none" style="color:darkslateblue;">Forget
                Your Password?</a>
        </div>
        <div class="text-center mt-1">
            <a href="{{ route('customer_register') }}" class="text-decoration-none"
                style="color:darkslateblue;">Customer Register</a>
        </div>
